                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">Reestablece tu contraseña</h4>
                                    <p class="mb-0">Escribe tu correo y porfavor espera unos pocos segundos para revisar tu bandeja</p>
                                </div>
                                <div class="card-body">
